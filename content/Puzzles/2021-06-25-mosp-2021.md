...
**Unrelated advertisement**: the [Carina Initiatives](https://www.carina.fund) is currently looking to hire a junior data scientist. They're a young philanthropic fund that's interested in supporting initiatives that build _actual_ math problem solving (like, the problem-solving you'd see on this blog, not [the mainstream buzzword stuff](https://www.google.com/search?q=math+problem+solving&tbm=isch)). I've had a lot of fun talking with them over the last few months about problem-solving in general.
