...
(seeing that I am spending the next week in [Romania](http://rmms.lbi.ro/rmm2019/index.php?id=participants_math))
...
![Flowchart from the Napkin]({static}/images/recent-flowchart.png)
...
- My [personal website](http://web.evanchen.cc/) has seen some updates and re-organization,
  including most notably the [OTIS lecture notes](http://web.evanchen.cc/excerpts.html) that I promised last Christmas,
