...
- **Pragmaticism**: the textbook should not start with foundational issues like logical quantifiers or set theory. I have held a long belief that these are emphatically not the right way to start proofs, because _in practice_ when one really does proofs, one is usually not thinking too much about the axioms of set theory.
...
The closest I got was Jospeh Rotman's _Journey Into Mathematics_ textbook, which satisfies the first three conditions but not the fourth (the book draws from algebra, geometry, and number theory). I adore Rotman's book and the copy I read at age 12 is tattered from extended use. I'd like to get the combinatorics in, too.

## Picking a fight

I should state now this is against common wisdom. [Terence Tao](https://terrytao.wordpress.com/career-advice/theres-more-to-mathematics-than-rigour-and-proofs/) for example describes mathematical education in three parts: pre-rigorous, rigorous, post-rigorous. Relevant quotes:
