...
I defined these in their full glory [a previous blog
post](https://blog.evanchen.cc/2014/11/18/set-theory-part-2-constructing-the-ordinals/),
...
![Ordinals up to $\omega^\omega$.]({static}/images/500px-omega-exp-omega-labeled.png)
...
Answer: you can't get $\omega$! It's not of the form $n+1$ for any of our natural numbers $n$ -- our finite induction only lets us get up to the ordinals less than $\omega$. Similarly, the simple $+1$ doesn't let us hit the ordinal $2\omega$, even if we already have $\omega+n$ for all $n$. Such ordinals are called **limit ordinals**. The ordinal that _are_ of the form $\alpha+1$ are called **successor ordinals**.
...
![Squidzilla.]({static}/images/squidzilla.png)
...
![Zornaholic.]({static}/images/zornaholic.png)
