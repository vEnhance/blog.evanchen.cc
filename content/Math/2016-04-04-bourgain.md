...
>
> Let $f : Z \rightarrow \mathbb R$, $\text{supp }(\widehat f) \subseteq S \subseteq Z$ with $S$ dissociated.
...
>
> $$
> \frac {\sup_{\xi \in \text{supp }(\widehat f)} \left\lvert \widehat f(\xi) \right\rvert}
>      {\inf_{\xi \in \text{supp }(\widehat f)} \left\lvert \widehat f(\xi) \right\rvert} \le 2016.
> $$
>
...
$\text{supp }(\widehat f) = D_1 \sqcup \dots \sqcup D_k \sqcup R$ where $R$ is
